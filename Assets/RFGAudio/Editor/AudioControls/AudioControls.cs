...
namespace RFG.Audio
{
  ...
  public class AudioControls : Editor
  {
    ...
    public void OnEnable()
    {
      ...
      var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/RFGAudio/Editor/AudioControls/AudioControls.uss");
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/RFGAudio/Editor/AudioControls/AudioControls.uxml");
