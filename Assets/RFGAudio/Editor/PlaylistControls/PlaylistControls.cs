...
namespace RFG.Audio
{
  ...
  public class PlaylistControls : Editor
  {
    ...
    public void OnEnable()
    {
      ...
      var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/RFGAudio/Editor/PlaylistControls/PlaylistControls.uss");
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/RFGAudio/Editor/PlaylistControls/PlaylistControls.uxml");
